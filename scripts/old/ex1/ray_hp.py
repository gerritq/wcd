...
from rnd import get_train_dev_tok_full_loss, get_train_dev_tok_pwl 
...
MODEL_DIR = os.path.join(BASE_DIR, "data/models/slm/ray_hp")
RAY_DIR = os.path.join(MODEL_DIR, ".ray_results")
...
def get_config(args, tokenizer):
    ...
    tune_config = {
        ...
        "max_grad_norm": tune.uniform(0.1, 1.5), # defaults to 1.0
