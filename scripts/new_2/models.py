...
from prompts import VANILLA_PROMPTS, EXPLANATION_PROMPTS
...
class LM(ABC):
    ...
    def __init__(self, 
        ...
        # Dirs
        self.data_dir = (os.path.join(DATA_DIR, "main") if not self.explanation 
                         else os.path.join(DATA_DIR, "annotation"))
        self.model_dir = None
        ...
        # Data
        self.prompt_template = EXPLANATION_PROMPTS if self.explanation else VANILLA_PROMPTS
        self.train_tok = None
...
class SLMLoRA(LM):
    ...
    def __init__(self, 
        ...
        self.model_dir = os.path.join(MODEL_DIR, "vanilla", self.lang)
        os.makedirs(self.model_dir, exist_ok=True)
...
class SLMATL(LM):
    ...
    def __init__(self, 
        ...
        self.model_dir = os.path.join(MODEL_DIR, "atl", self.lang)
        os.makedirs(self.model_dir, exist_ok=True)
...
class SLMClassifier(LM):
    ...
    def __init__(self, 
        ...
        self.model_dir = os.path.join(MODEL_DIR, "classifier", self.lang)
        os.makedirs(self.model_dir, exist_ok=True)
